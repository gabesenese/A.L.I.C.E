...
def test_cache_manager():
    ...
    from ai.infrastructure.cache_manager import initialize_cache, get_cache_manager
    ...
    print(f"✓ Confirmed deletion (get returned None)")
...
def test_metrics_collector():
    ...
    from ai.infrastructure.metrics_collector import initialize_metrics, get_metrics_collector
...
def test_structured_logging():
    ...
    from ai.infrastructure.structured_logging import configure_logging, get_structured_logger
...
def test_database_pool():
    ...
    from ai.infrastructure.database_pool import initialize_database, get_connection_pool, DatabaseConfig, DatabaseType
    
    # Initialize with SQLite for testing
    config = DatabaseConfig(
        db_type=DatabaseType.SQLITE,
        database='data/test_infrastructure.db'
    )
...
def test_task_queue():
    ...
    print("\n=== Testing Task Queue ===")
    from ai.infrastructure.task_queue import initialize_task_queue, get_task_queue, TaskPriority
