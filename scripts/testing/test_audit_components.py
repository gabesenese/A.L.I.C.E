...
def test_audit_components():
    ...
    try:
        ...
        create_scorer()
        print("[OK] Scorer initialized")
        print("  Signals created: 0")
    except Exception as e:
        print(f"[FAIL] {e}")
        return False
    ...
    try:
        ...
        create_injector()
        print("[OK] Feedback injector initialized")
    ...
    try:
        ...
        create_tracker()
        print("[OK] Metric tracker initialized")
        print("  Metrics file: data/training/metrics/domain_metrics.jsonl")
    except Exception as e:
        print(f"[FAIL] {e}")
        return False
