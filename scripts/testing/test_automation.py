...
def test_dangerous_domain_blocking():
    ...
    # Try promotion
    promotion_engine.scan_and_promote()
    ...
    if review_file.exists():
        ...
        if code_exec_in_review:
            ...
            print("[INFO] No dangerous patterns in review (may have existed already)")
