...
print("- Why hard-coded messages are bad")
print("- How Alice learns to formulate responses")
print("- How to refactor plugins")
print("- How to teach Alice new responses")
print("- Progressive independence system")
