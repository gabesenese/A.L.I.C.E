...
from ai.core.llm_policy import configure_minimal_policy, LLMCallType
...
class ScenarioRunner:
    ...
    def _determine_route(self, user_input: str, nlp_result) -> str:
        ...
        if (
            any(phrase in text_lower for phrase in vague_phrases)
            or "vague" in intent
            or "unclear" in intent
            or intent == "conversation:meta_question"
            or intent in ["vague_temporal_question", "vague_question", "vague_request"]
        ):
            return "CLARIFICATION"

        # Confidence-based clarification gate
        strong_domain_keywords = any(
            word in text_lower
            for word in [
                "email",
                "mail",
    ...
    def _get_alice_response(self, user_input: str, route: str) -> tuple:
        ...
        if route == "CONVERSATIONAL":
            ...
            return (
                "Could you clarify what you mean? I want to make sure I help you correctly.",
                llm_used,
            )
    ...
    def run_scenario(self, scenario: Scenario) -> List[ScenarioResult]:
        ...
        for i, step in enumerate(scenario.steps, 1):
            ...
            if self.teacher:
                ...
                comparison.get("quality_score", 0)
            ...
            if teacher_response:
                ...
                if needs_learning:
                    logger.info("    [LEARNING] Flagged for learning")
