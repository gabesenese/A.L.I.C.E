...
from ai.memory.session_summarizer import SessionSummarizer, SessionSummary
from ai.infrastructure.capability_constraints import get_capability_constraints_ledger, CapabilityLevel
from ai.core.result_quality_scorer import ResultQualityScorer, QualityScore
...
class TestMultiGoalArbitration:
    ...
    def test_multi_goal_priority_arbitration(self):
        ...
        low = arbitrator.add_goal("Low priority task", GoalPriority.LOW)
...
class TestExplainableRouting:
    ...
    def test_routing_logger_records_decisions(self):
        ...
        decision = logger.log_decision(
            ...
            candidates_considered=[
                {"name": "file_tool", "type": "tool", "score": 0.95, "reasoning": "Best match"},
            ],
    ...
    def test_routing_outcome_recording(self):
        ...
        assert decision.execution_success == True
    ...
    def test_routing_explainability(self):
        ...
        decision = logger.log_decision(
            ...
            decision_type=RoutingDecisionType.TOOL_DISPATCH,
            candidates_considered=[
                {"name": "weather_tool", "type": "tool", "score": 0.92, "reasoning": "Perfect match"},
            ],
