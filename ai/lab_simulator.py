...
class LabSimulator:
    ...
    def generate_stress_test_queries(
        ...
        query_templates = [
            ...
            lambda: {
                "query": f"Any emails from {inbox[0].get('from', 'someone')} if inbox else 'sender'?",
                "type": "email",
                "expected_tool": "email",
            },
            lambda: {
            ...
            lambda: {
                "query": "Show me next week's events",
                "type": "calendar",
                "expected_tool": "calendar",
            },
            # File queries
            lambda: {
                "query": "List my recent files",
                "type": "file_browse",
            ...
            lambda: {
                "query": "Show me files from Documents",
                "type": "file_directory",
                "expected_tool": "file_operations",
            },
            # General queries
    ...
    def save_stress_test(self, scenario: Dict[str, Any], num_queries: int = 50) -> str:
