...
class MemoryPruner:
    ...
    def prune_memories(self, memory_system) -> Dict[str, Any]:
        ...
        stats = {"archived": 0, "pruned": 0, "kept": 0, "errors": 0, "by_type": {}}
        ...
        try:
            ...
            logger.info(
                f"[MemoryPruner] Pruning complete: archived={stats['archived']}, pruned={stats['pruned']}, kept={stats['kept']}"
            )

            return {"success": True, "action": "prune_completed", "stats": stats}

        except Exception as e:
            logger.error(f"[MemoryPruner] Error during pruning: {e}", exc_info=True)
            return {"success": False, "action": "prune_error", "error": str(e)}
    ...
    def restore_from_archive(
        ...
        try:
            ...
            return {"success": False, "action": "restore_archive", "error": str(e)}
