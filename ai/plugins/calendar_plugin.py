...
try:
    ...
    print(
        "Warning: Google Calendar dependencies not available. Run: pip install google-auth google-auth-oauthlib google-api-python-client"
    )
            ...
            event = {
                ...
                "reminders": {
                    ...
                    "overrides": [
                        {
                            "method": "email",
                            "minutes": event_details.get("reminder_minutes", 15),
                        },
                        {
                            "method": "popup",
                            "minutes": event_details.get("reminder_minutes", 15),
