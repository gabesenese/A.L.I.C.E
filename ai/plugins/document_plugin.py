        ...
        try:
            ...
            # Document-related question that might need RAG
                ...
                return {
                    "success": False,
                    "response": None,
                    "data": {"error": "unknown_request", "message_code": "docs:help"},
                }
            ...
            return {
                "success": False,
                "response": None,
                "data": {"error": str(e), "message_code": "docs:execute_error"},
            }
        ...
        try:
            ...
            if not file_path:
                return {
                    "success": False,
                    "response": None,
                    "data": {"error": "no_path", "message_code": "docs:need_path"},
                }
            ...
            return {
                "success": False,
                "response": None,
                "data": {"error": str(e), "message_code": "docs:ingest_error"},
            }
    ...
    def _handle_document_search(self, query: str, entities: Dict) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": False,
                "response": None,
                "data": {"error": str(e), "message_code": "docs:search_error"},
            }
    ...
    def _handle_list_documents(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": False,
                "response": None,
                "data": {"error": str(e), "message_code": "docs:list_error"},
            }
    ...
    def _handle_document_question(self, query: str, entities: Dict) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": False,
                "response": None,
                "data": {"error": str(e), "message_code": "docs:question_error"},
            }
