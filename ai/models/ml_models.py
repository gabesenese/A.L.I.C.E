...
class RouterClassifier:
    ...
    ROUTES = {"CONVERSATIONAL": 0, "TOOL": 1, "CLARIFICATION": 2, "LLM_FALLBACK": 3}
...
class PatternClusterer:
    ...
    def find_pattern_candidates(
        self, fallback_interactions: List[Dict[str, Any]], min_cluster_size: int = 3
    ) -> List[Dict[str, Any]]:
        """
