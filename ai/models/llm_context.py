...
class LLMContext:
    ...
    def add_short_history(
        self, role: str, content: str, intent: str = None, entities: Dict = None
    ):
    ...
    def add_world_fact(
        self, entity: str, relation: str, value: Any, confidence: float = 1.0
    ):
        """Add world fact"""
        fact = WorldFact(
            entity=entity, relation=relation, value=value, confidence=confidence
        )
        self.world_facts.append(fact)
        self.enforce_limits()

    def add_tool_result(
        self, tool_name: str, success: bool, data: Any, error: str = None
    ):
        """Add tool result"""
        result = ToolResult(
...
class ContextBuilder:
    ...
    def set_user_input(
        self, user_input: str, intent: str = None, entities: Dict = None
    ) -> "ContextBuilder":
