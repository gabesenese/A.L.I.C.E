    ...
    def _init_tone_styles(self) -> Dict[ToneStyle, ToneCharacteristics]:
        ...
        return {
            ToneStyle.FORMAL: ToneCharacteristics(
                ...
                markers=[
                    "I shall", "I would", "It is beneficial",
                    "Furthermore", "In addition", "One must note"
                ]
            ),
            ToneStyle.CASUAL: ToneCharacteristics(
                ...
                explanation_depth="moderate",
                markers=[
                    "ha", "yeah", "honestly", "cool", "pretty neat",
                    "you know", "basically", "so like"
                ]
            ),
            ToneStyle.TECHNICAL: ToneCharacteristics(
                ...
                markers=[
                    "Algorithm", "Implementation", "Abstraction",
                    "Optimization", "Architecture", "Interface"
                ]
            ),
            ...
            ToneStyle.VERBOSE: ToneCharacteristics(
                ...
                explanation_depth="detailed",
                markers=[
                    "Let me explain", "So what's happening here",
                    "The thing about", "To be clear", "What I mean is"
                ]
            ),
            ToneStyle.WARM: ToneCharacteristics(
                ...
                explanation_depth="moderate",
                markers=[
                    "I understand", "I see", "That's tough",
                    "You're doing great", "It's okay", "I've got you"
                ]
            ),
        }
